...
var Search = function Search(_ref, URL) {
  ...
  _defineProperty(this, "fetchDataFromInput", function (value) {
    return fetch(_this.URL + value).then(function (res) {
      return res.json();
    }).then(_this.renderMarkup)["catch"](function (err) {
  ...
  _defineProperty(this, "renderMarkup", function (countries) {
...
new Search(js_refs, 'https://restcountries.com/v2/name/').addListeners();
})();
